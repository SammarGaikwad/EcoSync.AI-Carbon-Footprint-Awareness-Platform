...
function repairOrExtractJSON(rawText) {
  ...
  // 3. Fallback: Localized regex extraction to salvage numbers and fields
  ...
  if (mobilityModeMatch) {
    ...
    // Semantic scan fallbacks if type/mode key is missing
  ...
  // Salvage appliance durationHours
...
app.post('/api/parse', async (req, res) => {
  try {
    ...
    // Parse output using the JSON repair and fallback mechanism
